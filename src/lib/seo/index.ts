...
const normalizeSeoSettings = (doc: unknown): ISeoSettings | null => {
  ...
  return {
    ...
    analytics: {
      ...
      bingVerification: String(analyticsData.bingVerification || ''),
      ...
      xPixelId: String(analyticsData.xPixelId || ''),
      xLeadEventId: String(analyticsData.xLeadEventId || ''),
      xApiKey: String(analyticsData.xApiKey || ''),
      xApiSecret: String(analyticsData.xApiSecret || ''),
      xAccessToken: String(analyticsData.xAccessToken || ''),
      xAccessSecret: String(analyticsData.xAccessSecret || ''),
      linkedInPartnerId: String(analyticsData.linkedInPartnerId || ''),
      linkedInConversionId: String(analyticsData.linkedInConversionId || ''),
      linkedInAccessToken: String(analyticsData.linkedInAccessToken || ''),
      linkedInConversionUrn: String(analyticsData.linkedInConversionUrn || ''),
    },
    appearance: {
