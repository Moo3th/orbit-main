...
export default function Orb({ 
  ...
  const frag = /* glsl */ `
    ...
    const vec3 baseColor1 = vec3(0.478, 0.118, 0.180); // Burgundy #7A1E2E - Primary
    const vec3 baseColor2 = vec3(0.910, 0.863, 0.796); // Beige #E8DCCB - Secondary
    const vec3 baseColor3 = vec3(0.655, 0.663, 0.675); // Cool Gray #A7A9AC - Neutral
  ...
  useEffect(() => {
    ...
    const update = (t: number) => {
      ...
      // Throttle to 30fps and only update when in view
