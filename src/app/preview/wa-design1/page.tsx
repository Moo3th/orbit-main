        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-10">
          ...
          <div className="flex flex-wrap justify-center gap-3 md:gap-4">
            {INTEGRATIONS.map((name, i) => (
              <ScrollReveal key={i}>
                <div className="bg-white/5 backdrop-blur-sm rounded-2xl px-6 md:px-8 py-4 md:py-5 border border-white/10 hover:border-green-500/30 hover:bg-white/10 transition-all cursor-pointer">
