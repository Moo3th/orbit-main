...
export const DynamicFormPage = ({ productId, cmsPage: _cmsPage }: Props) => {
  ...
  if (fields.length === 0) return <div className="flex items-center justify-center min-h-[60vh]"><p className="text-gray-500">{isRTL ? 'لا يوجد نموذج متاح لهذا المنتج' : 'No form available for this product'}</p></div>;
