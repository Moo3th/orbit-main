...
const DEFAULT_NOTIFICATION_EMAIL = 'info@corbit.sa';
...
const ACTIVE_PAGE_BLUEPRINTS: PageBlueprint[] = [
  { id: 'home', path: '/', title: 'الصفحة الرئيسية', titleEn: 'Home', seo: { title: 'CORBIT | المدار - حلول تقنية رائدة', titleEn: 'CORBIT - Leading Technical Solutions', description: 'CORBIT المدار - مزود حلول تقنية رائد في المملكة العربية السعودية. خدمات الرسائل النصية SMS وواتساب أعمال API وبرامج الموارد البشرية وبوابات المراسلة الحكومية.', descriptionEn: 'CORBIT - Leading technical solutions provider in Saudi Arabia. SMS messaging, WhatsApp Business API, HR software, and government messaging gateways.', keywords: 'CORBIT, المدار, حلول تقنية, SMS, واتساب, السعودية, رسائل نصية', keywordsEn: 'CORBIT, technical solutions, SMS, WhatsApp, Saudi Arabia, messaging, API', canonical: 'https://corbit.sa/', noIndex: false, ogImage: '' } },
  { id: 'sms', path: '/products/sms', title: 'خدمة الرسائل النصية SMS', titleEn: 'SMS Service', seo: { title: 'خدمة الرسائل النصية SMS | المدار', titleEn: 'SMS Messaging Service | CORBIT', description: 'خدمة الرسائل النصية SMS من المدار - حلول مراسلة موثوقة وفعالة للشركات والمؤسسات في السعودية.', descriptionEn: 'SMS Messaging Service by CORBIT - Reliable and efficient messaging solutions for businesses in Saudi Arabia.', keywords: 'SMS, رسائل نصية, خدمة رسائل, المدار, السعودية', keywordsEn: 'SMS, messaging, text messages, CORBIT, Saudi Arabia, bulk SMS', canonical: 'https://corbit.sa/products/sms', noIndex: false, ogImage: '' } },
  { id: 'whatsapp', path: '/products/whatsapp', title: 'واتساب أعمال API', titleEn: 'WhatsApp Business API', seo: { title: 'واتساب أعمال API | المدار', titleEn: 'WhatsApp Business API | CORBIT', description: 'واتساب أعمال API من المدار - تواصل مع عملائك عبر واتساب بشكل احترافي وآمن.', descriptionEn: 'WhatsApp Business API by CORBIT - Connect with your customers professionally and securely via WhatsApp.', keywords: 'واتساب, WhatsApp, واتساب أعمال, API, المدار, تسويق', keywordsEn: 'WhatsApp, WhatsApp Business, API, CORBIT, marketing, messaging', canonical: 'https://corbit.sa/products/whatsapp', noIndex: false, ogImage: '' } },
  { id: 'otime', path: '/products/o-time', title: 'O-Time برنامج الموارد البشرية', titleEn: 'O-Time HR Software', seo: { title: 'O-Time برنامج الموارد البشرية | المدار', titleEn: 'O-Time HR Software | CORBIT', description: 'برنامج O-Time لإدارة الموارد البشرية - منصة متكاملة للحضور والرواتب ودورة حياة الموظف.', descriptionEn: 'O-Time HR Software - Complete platform for attendance, payroll, and employee lifecycle management.', keywords: 'O-Time, موارد بشرية, إدارة حضور, رواتب, المدار', keywordsEn: 'O-Time, HR, attendance, payroll, CORBIT, employee management', canonical: 'https://corbit.sa/products/o-time', noIndex: false, ogImage: '' } },
  { id: 'govgate', path: '/products/gov-gate', title: 'Gov Gate', titleEn: 'Gov Gate', seo: { title: 'Gov Gate بوابة حكومية | المدار', titleEn: 'Gov Gate | CORBIT', description: 'بوابة Gov Gate للحوسبة المؤسسية - منصة مراسلة آمنة ومتخصصة للجهات الحكومية.', descriptionEn: 'Gov Gate - Secure enterprise messaging gateway for government entities.', keywords: 'Gov Gate, بوابة حكومية, مراسلة, حكومة, المدار', keywordsEn: 'Gov Gate, government gateway, messaging, CORBIT, secure', canonical: 'https://corbit.sa/products/gov-gate', noIndex: false, ogImage: '' } },
  { id: 'schoolbit', path: '/products/schoolbit', title: 'SchoolBit إدارة المدارس', titleEn: 'SchoolBit School Management', seo: { title: 'SchoolBit | منصة إدارة المدارس والحضور والتواصل والتقارير', titleEn: 'SchoolBit | Smart School Management Platform', description: 'منصة ذكية لإدارة المدارس تجمع الطلاب، الحضور، الكادر، الجداول، الاختبارات، الرسائل، والتقارير في نظام واحد متكامل.', descriptionEn: 'A smart school management platform that brings together students, attendance, staff, schedules, exams, messaging, and reports in one integrated system.', keywords: 'SchoolBit, إدارة مدارس, حضور, تواصل, تقارير, المدار', keywordsEn: 'SchoolBit, school management, attendance, communication, reports, CORBIT', canonical: 'https://corbit.sa/products/schoolbit', noIndex: false, ogImage: '' } },
  { id: 'contact', path: '/contact', title: 'تواصل معنا', titleEn: 'Contact Us', seo: { title: 'تواصل معنا | المدار', titleEn: 'Contact Us | CORBIT', description: 'تواصل معنا - المدار لحلول التقنية. نحن هنا لمساعدتك في جميع استفساراتك.', descriptionEn: 'Contact CORBIT - We are here to help with all your inquiries.', keywords: 'تواصل معنا, المدار, اتصل بنا, دعم فني', keywordsEn: 'contact us, CORBIT, support, inquiry', canonical: 'https://corbit.sa/contact', noIndex: false, ogImage: '' } },
  { id: 'blog', path: '/blog', title: 'المدونة', titleEn: 'Blog', seo: { title: 'المدونة | المدار', titleEn: 'Blog | CORBIT', description: 'مدونة المدار - أحدث الأخبار والمقالات عن الحلول التقنية والاتصالات.', descriptionEn: 'CORBIT Blog - Latest news and articles about technology solutions and communications.', keywords: 'مدونة, المدار, أخبار تقنية, مقالات', keywordsEn: 'blog, CORBIT, tech news, articles', canonical: 'https://corbit.sa/blog', noIndex: false, ogImage: '' } },
];
...
const defaultContactSections: SeedSection[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'email', label: 'البريد الإلكتروني', labelEn: 'Email Address', type: 'text', value: 'info@corbit.sa', valueEn: 'info@corbit.sa' },
      ...
      { key: 'address_note', label: 'تفاصيل العنوان', labelEn: 'Address Details', type: 'text', value: 'طريق الملك عبدالله بن عبدالعزيز', valueEn: 'King Abdullah Bin Abdulaziz Rd.' },
...
const defaultPageSectionsById: Record<string, SeedSection[]> = {
  ...
  whatsapp: [
    ...
    { id: 'wa-pricing', name: 'تسعير واتساب', nameEn: 'WhatsApp Pricing', visible: true, fields: [
      ...
      { key: 'contact_note', label: 'نص ملاحظة الباقات', labelEn: 'Plans Note Text', type: 'textarea', value: 'الأسعار شهرية وشاملة ضريبة القيمة المضافة 15%. رسوم التأسيس والإعداد تُحدّد حسب كل حالة. تتوفر خصومات خاصة للشركات الكبرى والجهات الحكومية.', valueEn: 'Prices are monthly and include 15% VAT. Setup and onboarding fees are determined case by case. Special discounts are available for large companies and government entities.' },
      ...
      { key: 'billing_monthly_label', label: 'تسمية الدفع الشهري (المبدّل)', labelEn: 'Monthly Billing Label (toggle)', type: 'text', value: 'شهري', valueEn: 'Monthly' },
      { key: 'billing_yearly_label', label: 'تسمية الدفع السنوي (المبدّل)', labelEn: 'Yearly Billing Label (toggle)', type: 'text', value: 'سنوي', valueEn: 'Yearly' },
      { key: 'billing_yearly_period_label', label: 'الفترة بعد السعر السنوي', labelEn: 'Period After Yearly Price', type: 'text', value: 'سنوياً', valueEn: 'Yearly' },
      { key: 'billing_monthly_discount', label: 'خصم الباقات الشهرية % (0 = بدون خصم)', labelEn: 'Monthly Plans Discount % (0 = none)', type: 'text', value: '0', valueEn: '0' },
      { key: 'billing_yearly_discount', label: 'خصم الباقات السنوية % (0 = بدون خصم)', labelEn: 'Yearly Plans Discount % (0 = none)', type: 'text', value: '0', valueEn: '0' },
      { key: 'billing_discount_badge', label: 'نص شارة الخصم (تُلحق النسبة تلقائياً)', labelEn: 'Discount Badge Text (percent appended)', type: 'text', value: 'خصم', valueEn: 'Save' },
...
export async function POST(request: NextRequest) {
  try {
    ...
    const defaultWhatsAppFormConfig = {
      ...
      notificationEmails: 'info@corbit.sa',
      isActive: true,
      fields: [
